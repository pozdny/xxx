...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a class="selected" href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
                ...
                <td id="sizeTd" class="inputImg"></td>
            </tr>
            <tr>
                <td></td>
                <td>
                   <div id="product-size" class="scrollbox"></div>
                </td>
            </tr>
            <tr>
                <td>Категория комплектующих</td>
                <td>
                  <select name="main_complects_id" id="main_complects_id">
                      <option value="0" selected="selected"><?php echo $text_none; ?></option>
                      <?php foreach ($complects as $product_complects) { ?>
                        <option value="<?php echo $product_complects['complect_id']; ?>" data-internal-id="<?php echo $product_complects['complect_category_id']; ?>"><?php echo $product_complects['name']; ?></option>
                      <?php } ?>
                  </select>
                </td>
            </tr>
            <tr>
                <td>Комплектующие</td>
                <td id="complectsTd" class="inputImg"></td>
            </tr>
            <tr>
                <td></td>
                <td>
                   <div id="product-complects" class="scrollbox"></div>
                </td>
            </tr>
            <tr>
              <td><?php echo $entry_category; ?></td>
              <td><div class="scrollbox" id="showCategory">
                  <?php $class = 'odd'; ?>
            ...
            <tr>
                <td><?php echo $entry_other_color; ?></td>
                <td id="colorTd" class="inputImg"></td>
            </tr>
            <tr>
               <td></td>
               <td>
                  <div id="product-colors" class="scrollbox"></div>
               </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>В рекомендуемые</td>
                <td><input type="checkbox" name="featured" <?php echo $featured_checked; ?> id="check_featured"></td>
            </tr>
          </table>
        </div>
...
<?php  if($featured_checked ==''){ ?>
<script type="text/javascript">
    $(function () {
        // REMOVE CHECKBOX CHECKED
        $("#check_featured").removeAttr('checked');
    });
</script>
<?php } ?>
...
<script id="sizeTemplate" type="text/template">
    <select name="sizeElem" id="sizeElem"><%= size %></select>
    <input type="text" name="priceElem" value="" id="priceElem" placeholder="цена">
    <img src="view/image/add.png" alt="" />
</script>
<script id="sizeTemplateSelected" type="text/template">
    <%= size %> <%= price %>
    <img alt="" src="view/image/delete.png">
    <input type="hidden" value="<%= valueCatId %>" name="<%= name_input %>[<%= valueSize %>][valueCatId]">
    <input type="hidden" value="<%= valueSize %>" name="<%= name_input %>[<%= valueSize %>][size_id]" class="sizeVal">
    <input type="hidden" value="<%= valuePrice %>" name="<%= name_input %>[<%= valueSize %>][price]">

</script>
<script id="colorTemplate" type="text/template">
    <select name="colorElem" id="colorElem"><%= color %></select>
    <img src="view/image/add.png" alt="" />
</script>
<script id="colorTemplateSelected" type="text/template">
    <%= name %>
    <img alt="" src="view/image/delete.png">
    <input type="hidden" value="<%= productId %>" name="<%= name_input %>[]" class="sizeVal">
</script>
<script type="text/javascript"><!--
