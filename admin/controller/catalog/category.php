...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_economy_price'] = $this->language->get('economy_price');
 		if (isset($this->error['warning'])) {
			$this->data['error_warning'] = $this->error['warning'];
		} else {
			$this->data['error_warning'] = '';
		...
		if (isset($this->request->post['economy_price'])) {
			$this->data['economy_price'] = $this->request->post['economy_price'];
		} elseif (!empty($category_info)) {
			$this->data['economy_price'] = $category_info['economy_price'];
		} else {
			$this->data['economy_price'] = 0;
		}
