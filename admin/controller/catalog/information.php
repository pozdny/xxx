...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm() {
        ...
        // Categories
        $categories = $this->model_catalog_information->getCategoryNotes();
    ...
    private function getAllCategories($categories) { //echo '<pre>'; print_r($categories); echo '</pre>'; echo $category_id;
