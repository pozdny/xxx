...
$_['text_complects']    = 'Комплектующие';
$_['text_complect_consist'] = '(Цена указана за полотно)';
$_['text_montag']       = 'Добавить к заказу "монтаж за 24 часа" с 30% скидкой';
$_['text_economy']      = '(Вы экономите от %s руб.)';
$_['text_zamer']        = 'Если сомневаетесь в размерах, закажите бесплатный ';
// Entry
