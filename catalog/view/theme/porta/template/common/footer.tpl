        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="container">
                    ...
                    <div>
                        Не является публичной офертой. Технические характеристики, наличие товара и цены могут отличаться от указанных на сайте.<br>
                        Продавец в праве изменять цены и характеристики без предварительного уведомления.
                    </div>
                </div>
            </div>
        </div>
...
<div id="myModalZamer" class="modal modalCustom">
    <div class="modal-content">
        ...
        <p>Наша компания предлагает Вам замер на выгодных условиях.<br>
            Замер стоит 200 руб. (до 9 дверей), а при установке мы возвращаем Вам эти деньги обратно.<br>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter29086635 = new Ya.Metrika({
                    id:29086635,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/29086635" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>