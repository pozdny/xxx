  	...
  	public function index() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setTo($this->config->get('config_email'));
	  		...
	  		$this->redirect($this->url->link('information/contacts/success'));
    	}
    	...
    	$this->data['button_continue'] = $this->language->get('button_continue'); //echo '<pre>'; print_r($this->config); echo '</pre>';

		$this->data['action'] = $this->url->link('information/contacts');
