...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			$this->data['md'] = false;
			$this->data['vd'] = false;
			$manuf_ackija_array = array("vladimirskaja_fabrika", "garda", "kaiser", "almaz", "zevs", "joshkar", "legion", "sibir", "stroygost");
			$retargeting_vk_array = array("garda", "kaiser", "zevs", "joshkar", "legion", "sibir", "stroygost");
			$this->data['retargeting_vk'] = false;
			if(in_array(trim($manufacturer_info['keyword']), $manuf_ackija_array)){
				$this->data['vd'] = true;
				$this->data['md'] = false;
			}
			else{
			...
			if(in_array(trim($manufacturer_info['keyword']), $retargeting_vk_array)){
