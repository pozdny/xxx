...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        foreach ($this->model_catalog_information->getInformations() as $result) {//echo '<pre>'; print_r($result); echo '</pre>';
            if ($result['category_id'] == 1) {
                ...
                if ($query->num_rows) {
                    ...
                    elseif($query->row['keyword'] == 'contacts'){
                        $url = '/' . $query->row['keyword'];
                        $this->data['informations'][] = array(
                            'title' => $result['title'],
                            'href'  => $this->url->link('information'.$url)
        ...
        $this->data['cart_title'] = $this->language->get('cart_title');
