...
class ControllerCheckoutGuest extends Controller {
  	public function index() {
        ...
        $this->data['entry_firstname_placeholder'] = $this->language->get('entry_firstname_placeholder');
		$this->data['entry_lastname'] = $this->language->get('entry_lastname');
		$this->data['entry_email'] = $this->language->get('entry_email');
        $this->data['entry_email_placeholder'] = $this->language->get('entry_email_placeholder');
		$this->data['entry_telephone'] = $this->language->get('entry_telephone');
        $this->data['entry_telephone_placeholder'] = $this->language->get('entry_telephone_placeholder');
    ...
    public function save() {
        ...
        if (!$json) {
            if ((utf8_strlen(trim($this->request->post['firstname'])) < 1) || (utf8_strlen(trim($this->request->post['firstname'])) > 32)) {
                ...
                if (!preg_match('/^[а-яё \-]+$/iu', $this->request->post['firstname'])) {
                    $json['error']['firstname'] = $this->language->get('error_firstname_rus');
                }
            }
            ...
            */
            ...
            if ((utf8_strlen($this->request->post['telephone']) < 6) || (utf8_strlen($this->request->post['telephone']) > 15)) {
        ...
        if (!$json) {
            $this->session->data['account'] = 'guest';
            $this->request->post['lastname'] = 'no_data';
            $this->request->post['company'] = '';
            $this->request->post['address_1'] = 'no_data';
            $this->request->post['address_2'] = '';
            $this->request->post['postcode'] = '';
            $this->request->post['city'] = 'no_data';
            $this->request->post['country_id'] = '176';
            $this->request->post['zone_id'] = '90';
